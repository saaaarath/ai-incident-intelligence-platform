...
The Docker Compose simulation starts PostgreSQL, Apache Kafka (KRaft), Order Service, Payment Service, and Inventory Service with health-gated dependencies and an internal service network.
